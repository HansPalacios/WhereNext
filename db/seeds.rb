...
Bar.create([
	...
	{name: 'Skinny Dennis', image: File.new("#{Rails.root}/images/skinnydennis.png"), address: '152 Metropolitan Ave', phone_number: '347-422-0939', description: 'A honkey-tonk-themed dive bar, and it’s where you go to stand around and drink cheap beer with friends.', rating_id: 9, music: true, sports: false, dancing: false, beer: true, cocktails: true, wine: false, rooftop: false, cheap_food: false, dress_code: false, line: false, popular_nights: [1, 2, 5, 6], karaoke: false
	},
	...
	{name: 'The Gibson', image: File.new("#{Rails.root}/images/thegibson.jpg"), address: '108 Bedford Ave', phone_number: '718-387-6296', description: 'A neighborhood bar with an outstanding collection of craft beer and whiskey.', rating_id: 9, music: false, sports: true, dancing: false, beer: true, cocktails: true, wine: true, rooftop: false, cheap_food: true, dress_code: false, line: false, popular_nights: [1, 4, 5, 6], karaoke: false
		},
