...
Bar.create!([
	# {name: 'Westlight', address: '111 N 12th St', phone_number: '718-307-7100', description: 'fancy rooftop bar on top of the even fancier new William Vale hotel in Brooklyn feels like something you would find in Manhattan', rating_id: 8, music: false, sports: false, dancing: false, beer: true, cocktails: true, wine: true, rooftop: true, cheap_food: false, dress_code: true, line: true, popular_nights: [4, 5, 6], karaoke: false, image: File.new("#{Rails.root}/images/Westlight.jpg")}
...
# User.create([
# 	{email: "hanssebastian.p@gmail.com", password: "pineapple", password_confirmation: "pineapple", admin: true},
# 	{email: "erinkarlayoung@gmail.com", password: "12345678", password_confirmation: "12345678", admin: true}
# 	])

# User.create(email: "hanssebastian.p@gmail.com", password: "pineapple", password_confirmation: "pineapple", admin: true)
